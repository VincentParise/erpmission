 ...
 * @ORM\Table(name="contacts",indexes={@ORM\Index(columns={"firstname","lastname"},flags={"fulltext"})})
 */
class Contacts implements UserInterface
{
    ...
    {
        return 'Code : '.$this->getCodename().' Nom : '.$this->getLastname().' Pays : '.$this->getPays();
    }
